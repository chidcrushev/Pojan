/**
 * Handle Application Pagination
 */
class Pagination{

    /**
     *m Initialize pagination properties
     * @param {*} totalCount 
     * @param {*} currentPage 
     * @param {*} pageUri 
     * @param {*} perPage 
    ...
    links(){
        ...
        if(this.previousPage > 0)
            ...
            /*Add back links*/
            if(this.currentPage > 1){
                for (let x = this.currentPage - this.sidePages; x < this.currentPage; x++) {
                    if(x > 0)
            ...
            /*Add more links*/
            for(let x = this.nextPage; x <= this.pageCount; x++){
